...
@app.command()
def run_training_typer(model_name: Annotated[str, typer.Option("--model_name", "-m")] = "simple",
...
def run_training_hydra(cfg) -> Any:
    ...
    train_model(cfg.hyperparameters.model_name, cfg.hyperparameters.batch_size, 
                cfg.hyperparameters.epochs, cfg.hyperparameters.wandb_logging)
