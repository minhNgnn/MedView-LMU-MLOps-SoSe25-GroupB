...
def train_model(model_name: str, epoch: int = 10) -> Any:
    ...
    yaml_file_path_dict = {"yolov8n": "data/BrainTumor/BrainTumorYolov8/data.yaml", "yolov9n": "data/BrainTumor/BrainTumorYolov9/data.yaml", "yolov11n": "data/BrainTumor/BrainTumorYolov11/data.yaml",
    ...
    results = T_Model.train(data= yaml_file_path_dict[model_name], epochs=epoch, patience=20, batch= -1, optimizer='auto',
